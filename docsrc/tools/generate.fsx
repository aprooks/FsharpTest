...
let githubLink = "https://github.com/Update GitHome in build.fsx/FsxTest"

// Specify more information about your project
let info =
  [ "project-name", "FsxTest"
    "project-author", "Update Author in build.fsx"
    "project-summary", "testing fsx and F# 4.1"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/FsxTest" ]
